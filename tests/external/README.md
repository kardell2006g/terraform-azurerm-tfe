# TFE on Azure - External (Public-facing)
This scenario deploys TFE with an Azure Load Balancer that has a public IP and is external-facing. This use case is good for users whose VCS and/or CI/CD tooling is a hosted SaaS. This scenario leverages the _online_ installation method, however _airgap_ would also work fine.
