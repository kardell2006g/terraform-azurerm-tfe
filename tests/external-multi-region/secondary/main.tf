...
module "tfe_secondary" {
  ...
  tfe_resource_group_name_primary = var.tfe_resource_group_name_primary
  storage_account_name_primary    = var.storage_account_name_primary
  storage_container_name_primary  = var.storage_container_name_primary
